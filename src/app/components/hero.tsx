...
import { personalInfo, quickFacts } from "../../lib/content";
          ...
          <div className="space-y-8 order-2 lg:order-1">
            ...
            >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-2 px-6 py-3 border border-border rounded-full font-medium transition-colors hover:bg-[#0A66C2]/50"
              >
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -inset-4 bg-gradient-to-r from-blue-500/20 via-cyan-500/20 to-teal-500/20 dark:from-blue-500/10 dark:via-cyan-500/10 dark:to-teal-500/10 rounded-3xl blur-2xl"
              />
              ...
              <div className="relative w-80 h-80 md:w-96 md:h-96 lg:w-[28rem] lg:h-[28rem]">
                ...
                <div className="absolute inset-2 rounded-3xl overflow-hidden bg-card">
                  <img
                    src="https://images.unsplash.com/photo-1737575655055-e3967cbefd03?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBwb3J0cmFpdCUyMGRldmVsb3BlcnxlbnwxfHx8fDE3Njc3MTUzMzd8MA&ixlib=rb-4.1.0&q=80&w=1080"
                ...
                <motion.div
                  ...
                  className="absolute -right-4 top-8 bg-card/90 backdrop-blur-sm border border-border rounded-lg p-3 shadow-xl"
                >
                ...
                <motion.div
                  ...
                  className="absolute -left-4 bottom-8 bg-card/90 backdrop-blur-sm border border-border rounded-lg p-3 shadow-xl"
                >
